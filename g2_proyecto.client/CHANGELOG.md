...
- Cree un proyecto de Angular con ng: `ng new g2_proyecto.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`g2_proyecto.client.esproj`).
